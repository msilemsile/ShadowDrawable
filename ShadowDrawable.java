...
/**
 * 阴影drawable(copy {@link android.support.v7.widget.RoundRectDrawableWithShadow})
 */
public class ShadowDrawable extends android.graphics.drawable.Drawable {
    ...
    public ShadowDrawable(int radius, int shadowColor, int shadowElevation) {
        this(radius, shadowColor, 0, shadowElevation);
    }

    public ShadowDrawable(int radius, int shadowStartColor, int shadowEndColor, int shadowElevation) {
